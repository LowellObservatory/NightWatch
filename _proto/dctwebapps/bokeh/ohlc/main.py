...
p = figure(plot_height=200, tools="xpan,xwheel_zoom,xbox_zoom,reset", x_axis_type=None, y_axis_location="right")
...
mean = Slider(title="mean", value=0, start=-0.01, end=0.01, step=0.001, width=100)
stddev = Slider(title="stddev", value=0.04, start=0.01, end=0.1, step=0.01, width=100)
mavg = Select(value=MA12, options=[MA12, MA26, EMA12, EMA26], width=100)
...
#curdoc().add_root(column(row(mean, stddev, mavg), gridplot([[p], [p2]], toolbar_location="left", plot_width=400)))
curdoc().add_root(column(gridplot([[p], [p2]], toolbar_location="left", plot_width=380)))
