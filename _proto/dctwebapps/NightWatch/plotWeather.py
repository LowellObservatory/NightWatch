...
class plotWeather(object):
  ...
  def readTempData():
    ...
    file_path = '/Users/dlytle/python/webproto/bok-dj-examp/graphs/static/data/{}_weather.csv'.format(station)
    ...
    p.line('date', 'temp', line_width=3,source=source, color="red")
